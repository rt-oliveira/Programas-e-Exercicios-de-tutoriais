...
namespace Switch_case
{
    public partial class Form1 : Form
    {
        ...
        private void CboSemana_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            /*o conteudo da combobox (cboSemana) será analisado e de acordo com a opção
            escolhida, aparecerá uma determinada mensagem, caso o usuário escolha Domingo, será uma msg, caso
            seja segunda aparecerá outra msg e assim por diante, a cada case uma nova opção.
