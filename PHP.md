...
| Nome                       | Descrição                                                                             | Site do Tutorial                                                | Arquivo                                             |
| -------------------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------- | --------------------------------------------------- |
| Classe anônima             | Um exemplo de uso de classe anônima.                                                  | [Site do tutorial](https://www.youtube.com/watch?v=A4sk3_cFuEA) | [Arquivo](PHP/Classe%20anônima.php)                 |
| CSPRNG                     | Um exemplo de uso de funções da API CSPRNG.                                           | [Site do tutorial](https://www.youtube.com/watch?v=-60KA60ga48) | [Arquivo](PHP/CSPRNG.php)                           |
