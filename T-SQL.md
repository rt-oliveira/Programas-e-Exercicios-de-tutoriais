...
| Nome           | Descrição                                                                               | Site do Tutorial                                                                                  | Arquivo                                                                                          |
|----------------|-----------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------|
| Função CEILING | Mostra um exemplo da função CEILING, que retorna o menor inteiro maior que um número.   | [Site do tutorial](https://www.tutorialspoint.com/sql/sql-numeric-functions.htm#function_ceiling) | [Arquivo](T-SQL/Função%20CEILING.sql)<br>[Arquivo](T-SQL%2FFun%C3%A7%C3%A3o%20CEILING%20(2).sql) |
...
| Função LOG     | Mostra um exemplo da função LOG, que retorna o valor do logaritmo natural de um número. | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_numeric_functions.htm)              | [Arquivo](T-SQL/Função%20LOG.sql)                                                                |
...
| Função SQRT    | Mostra um exemplo da função SQRT, que retorna o valor da raiz quadrada de um número.    | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_numeric_functions.htm)              | [Arquivo](T-SQL/Função%20SQRT.sql)                                                               |
...
| Função DIFFERENCE | Mostra um exemplo da função DIFFERENCE, que diz o grau de similaridade entre duas strings.                    | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_string_functions.htm) | [Arquivo](T-SQL/Função%20DIFFERENCE.sql) |
| Função FORMAT     | Mostra um exemplo da função FORMAT, que formata dados para determinados padrões.                              | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_string_functions.htm) | [Arquivo](T-SQL/Função%20FORMAT.sql)     |
...
| Função SOUNDEX    | Mostra um exemplo da função SOUNDEX, que retorna o código Soundex de uma string.                              | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_string_functions.htm) | [Arquivo](T-SQL/Função%20SOUNDEX.sql)    |
...
| Função STR        | Mostra um exemplo da função STR, que converte números em strings.                                             | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_string_functions.htm) | [Arquivo](T-SQL/Função%20STR.sql)        |
| Função STUFF      | Mostra um exemplo da função STUFF, que substitui partes de uma string por outra string.                       | [Site do tutorial](https://www.tutorialspoint.com/t_sql/t_sql_string_functions.htm) | [Arquivo](T-SQL/Função%20STUFF.sql)      |
